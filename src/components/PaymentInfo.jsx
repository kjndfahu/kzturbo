...
function PaymentInfo() {
    return (
        <div className="flex items-center xl:mt-[450px] wmn:mt-[130px] lg:mt-[70px] mdbvp:mt-[30px] md:mt-[200px] mt-[120px] z-[1] justify-between lgbvp:px-[140px] lg:px-[70px] md:px-[40px] px-[5px]">
