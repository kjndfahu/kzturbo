...
function LeaveRequest() {
    return (
        <div className="flex w-[90%] bg-[#05A5C8] md:mt-[80px] mt-[26px] lg:px-[77px] md:px-[40px] px-[19px] mb-[23px] rounded-r-[30px] pt-[24px] text-white">
            ...
            <img className="lgbvp:flex hidden absolute ftr:w-[688px] w-[500px] ftr:h-[526px] h-[380px] xlbvp:left-[800px] wmn:left-[650px] ftr:left-[600px] left-[580px] xlbvp:top-[2900px] wmn:top-[2650px] ftr:top-[2600px] lgbvp:top-[2800px] top-[3350px]" src={woman} alt=""/>
        </div>
    )
}
