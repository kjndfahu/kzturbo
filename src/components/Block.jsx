function Block({maintext, firsttext, sectext, number}){
    return (
        <div className="border-[3px] z-10 w-[321px] lgbvp:h-[187px] h-[140px] border-cyan-400 rounded-lg px-[22px] pt-[21px] pb-[37px] shadow-lg flex flex-col relative text-gray-700 bg-white bg-gradient-to-b from-white via-gray-100 to-white">
