        ...
        <div
            ...
            <div className="absolute xl:top-[1850px] lgbvp:top-[1525px] mdbvp:top-[1770px] md:top-[1870px] smbvp:top-[1700px] top-[1660px] font-black">
                <div className="flex flex-col z-[1] gap-1 absolute lg:left-[150px] mdbvp:left-[100px] md:left-[70px] smbvp:left-[75px] left-[50px] lg:top-[80px] md:top-[45px] smbvp:top-[30px] top-[27px]">
                    ...
                    <div onClick={() => setModal(true)} className="mdbvp:flex  hidden items-center lg:text-[16px] text-[12px] rounded-[6px] text-[#05A5C8] justify-center lg:w-[210px] lg:h-[41px] w-[150px] h-[31px] bg-[#FFF800]">ПОЛУЧИ БЕСПЛАТНО</div>
                </div>
            ...
            <div className="flex mdbvp:flex-row items-center flex-col lgbvp:gap-[30px] gap-[15px]">
                <div
                    ...
                    className="flex z-[1] mdbvp:hidden font-black items-center lg:text-[16px] text-[12px] rounded-[6px] text-[#05A5C8] justify-center lg:w-[210px] lg:h-[41px] w-[210px] h-[41px] bg-[#FFF800]">ПОЛУЧИ
                    БЕСПЛАТНО
                </div>
                <div
