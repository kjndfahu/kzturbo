    ...
    return (
        <div
            ...
            <div className="absolute xl:top-[1850px] lgbvp:top-[1525px] mdbvp:top-[1770px] md:top-[1870px] smbvp:top-[1700px] top-[1660px] font-black">
                <div className="flex flex-col gap-1 absolute z-[10] lg:left-[150px] mdbvp:left-[100px] md:left-[70px] smbvp:left-[75px] left-[50px] lg:top-[80px] md:top-[45px] smbvp:top-[30px] top-[27px]">
                    <h2 className="text-white lg:leading-[45px] lg:text-[35px] mdbvp:text-[25px] md:text-[19px] md:leading-[22px] mdbvp:leading-[30px] smbvp:text-[18px] text-[17px] leading-[18px] smbvp:leading-[22px]">Первый займ <br/> бесплатно!</h2>
                    ...
                    <div className="mdbvp:flex hidden items-center lg:text-[16px] text-[12px] rounded-[6px] text-[#05A5C8] justify-center lg:w-[210px] lg:h-[41px] w-[150px] h-[31px] bg-[#FFF800]">ПОЛУЧИ БЕСПЛАТНО</div>
                </div>
            ...
            <div className="flex mdbvp:flex-row items-center flex-col lgbvp:gap-[30px] gap-[15px]">
                <div
                    className="flex mdbvp:hidden font-black items-center lg:text-[16px] text-[12px] rounded-[6px] text-[#05A5C8] justify-center lg:w-[210px] lg:h-[41px] w-[210px] h-[41px] bg-[#FFF800]">ПОЛУЧИ
                    БЕСПЛАТНО
                </div>
                <div
